...
Nesta seção, você vai além do CRUD básico e começa a criar comportamentos mais específicos da aplicação. É aqui que as actions aparecem como um recurso importante para deixar a API mais expressiva.

## Objetivo da seção

Ao final desta seção, você vai conseguir criar actions personalizadas, documentá-las no Swagger e aplicá-las tanto em livros quanto em compras.

## Aulas

- [7.1 Alteração do preço de um livro](07-01-alteracao-do-preco-de-um-livro.md)
