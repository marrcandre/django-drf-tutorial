...
Esta seção reúne endpoints fora do CRUD básico, cobrindo actions em recursos individuais e em coleções.

## Objetivo da seção

Ao final desta seção, você deverá conseguir criar actions personalizadas, documentá-las no Swagger e aplicá-las tanto em livros quanto em compras.
